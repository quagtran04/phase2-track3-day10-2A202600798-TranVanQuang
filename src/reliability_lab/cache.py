...
class SharedRedisCache:
    ...
    Implements get() and set() with Redis commands
    ...
    def get(self, query: str) -> tuple[str | None, float]:
        ...
        for key in self._redis.scan_iter(f"{self.prefix}*"):
            ...
            if score > best_score:
                ...
                best_response_raw = self._redis.hget(best_key, "response")
                best_response = str(best_response_raw) if best_response_raw is not None else None
                best_score = score
